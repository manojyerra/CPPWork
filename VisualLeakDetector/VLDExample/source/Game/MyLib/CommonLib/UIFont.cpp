...
UIFont::UIFont()
{
	...
	_textureInfo = TextureManager::GetInstance()->CreateTexture("font/fontimage.png");
	_textureInfoNew = TextureManager::GetInstance()->CreateTexture("font/fontimagenew.png");
...
u1[(int)'f'] = 183; v1[(int)'f'] = 412; cw1[(int)'f'] = 18; ch1[(int)'f'] = 49;
u1[(int)'g'] = 202; v1[(int)'g'] = 412; cw1[(int)'g'] = 28; ch1[(int)'g'] = 49;
u1[(int)'h'] = 238; v1[(int)'h'] = 412; cw1[(int)'h'] = 26; ch1[(int)'h'] = 49;
u1[(int)'i'] = 273; v1[(int)'i'] = 412; cw1[(int)'i'] = 12; ch1[(int)'i'] = 49;
